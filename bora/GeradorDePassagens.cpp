...
void GeradorDePassagens::Desalocando(){
    for(int i = 0; i<PassagensAviao.size(); i++){
        PassagensAviao.erase(PassagensAviao.begin());
    }
    for(int i = 0; i<PassagensOnibus.size(); i++){
        PassagensOnibus.erase(PassagensOnibus.begin());
    }
    for(int i = 0; i<PassagensCruzeiro.size(); i++){
        PassagensCruzeiro.erase(PassagensCruzeiro.begin());
    }
    for(int i = 0; i<PassagensVendidasAviao.size(); i++){
        PassagensVendidasAviao.erase(PassagensVendidasAviao.begin());
    }
    for(int i = 0; i<PassagensVendidasOnibus.size(); i++){
        PassagensVendidasOnibus.erase(PassagensVendidasOnibus.begin());
    }
    for(int i = 0; i<PassagensVendidasCruzeiro.size(); i++){
        PassagensVendidasCruzeiro.erase(PassagensVendidasCruzeiro.begin());
    }
