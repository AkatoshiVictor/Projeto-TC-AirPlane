...
class Produto{
    ...
    public:
        Produto(string, string, string, string, string, float, int, int, int, int, int, int, int);
        Produto(string, int, int, int, int, int, int, int, string, string, int);
        ...
        void set_origem(string);
        void set_tempo(string);
