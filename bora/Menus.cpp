...
int const Menus::ClienteInserindoData(){
    ...
    MensagemAmigavel.push_back("08 - O VALOR DA SUA PASSAGEM IRÁ SUBIR EM 75% CASO DEFINA UMA DATA PARA VOLTA");
    MensagemAmigavel.push_back("09 - AS PASSAGENS SÓ PODEM SER COMPRADAS COM NO MÍNIMO 48 HORAS DE ANTECDÊNCIA");
    MensagemAmigavel.push_back("10 - OS CRUZEIROS ZARPAM SOMENTE NOS DIAS 07 E 21 DE CADA MÊS");
    MensagemAmigavel.push_back("");
